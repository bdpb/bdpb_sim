...
var tblCharaMaster = [
  ...
  [ // R+
    ...
    [ "エギル・マイヤー",                    84, 27, 18, 20, 22, 22, 20, 18, "天使の加護" ],
    [ "ビー・ホーク",                        90, 19, 18, 20, 18, 20, 22, 22, "オールカウンターLv2" ],
    [ "リアウ・アイム",                      90, 19, 20, 20, 20, 20, 22, 20, "闇火属性半減" ],
    [ "イワン・ジインズ",                    96, 19, 22, 20, 16, 20, 22, 20, "不屈の闘志" ],
    [ "ヴェロニカ・ドビアーシュ",            84, 19, 22, 20, 18, 22, 22, 20, "プレッシャー" ],
    [ "レティシア・メリナ",                  90, 28, 18, 16, 22, 22, 20, 20, "星のオーラ Lv2 (知性+4,素早さ+4,MP+4%)" ],
  ],
  ...
  [ // SR
    ...
    [ "ブレット・アッシュベリー",            96, 27, 22, 22, 22, 22, 22, 22, "天竜の構えLv4" ],
    [ "コーネリア・アトウッド",              96, 27, 22, 22, 22, 22, 22, 22, "吽形" ],
    [ "アイナ・アクスバリ",                  96, 27, 22, 22, 22, 22, 22, 22, "自動リレイズ" ],
    [ "アイノ・アクスバリ",                  96, 27, 22, 22, 22, 22, 22, 22, "格闘威力UP:Lv4" ],
    [ "ジル・ベキュ",                        96, 27, 22, 22, 22, 22, 22, 22, "夢のステップLv3" ],
  ],
...
var tblAbility = {
  ...
  "星のオーラ Lv1 (知性+2,素早さ+2,MP+2%)":   [ 1.00, 1.02,  0,  0,  2,  0,  2,  0 ],
  "星のオーラ Lv2 (知性+4,素早さ+4,MP+4%)":   [ 1.00, 1.04,  0,  0,  4,  0,  4,  0 ],
  "星のオーラ Lv3 (知性+6,素早さ+6,MP+6%)":   [ 1.00, 1.06,  0,  0,  6,  0,  6,  0 ],
  "星のオーラ Lv4 (知性+8,素早さ+8,MP+8%)":   [ 1.00, 1.08,  0,  0,  8,  0,  8,  0 ],
  "星のオーラ Lv5 (知性+10,素早さ+10,MP+10%)":[ 1.00, 1.10,  0,  0, 10,  0, 10,  0 ],
